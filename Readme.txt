...
Модель RandomForestClassifier с параметрами depth=29, n_estimators=30, min_samples_leaf = 7, на выборке с заполнением методом 
SimpleImputer median и с методом балансирования классов upscaling показала на тестовой выборке F1-метрику = 0.617 и AUC_ROC=0.845
